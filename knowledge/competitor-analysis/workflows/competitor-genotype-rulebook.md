...
| 3 | ;;Votes;Budget;Need;;[comp1];[comp2];… |
| 4 | (при необходимости) |

Колонки 1–6: Section, Need, Votes, Budget, Need taxonomy, пусто.  
...
|-------|-------|-------|-------|-------|-------|--------|
| Section или пусто | я хочу … | Votes* | Budget* | T/M/D/N/U | пусто | 1 или пусто |

*Votes/Budget для competitor-genotype можно оставить пустыми или использовать Votes = «сколько конкурентов закрывают эту потребность».
